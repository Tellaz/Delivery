...
export default {
    ...
    methods: {
        ...
        async deleteItemConfirm() {
                ...
                this.defaultService.delete(this.spaceShipType).then(res => {
                ...
                this.dialogOptions.message = "Não foi possível excluir o tipo de nave!"
        ...
        async submit() {
            ...
            if (this.spaceShipType.id) {
                if (!isFormCorrect) {
                    ...
                    this.defaultService.put(this.spaceShipType).then(res => {
                    this.dialogOptions.title = "Sucesso!"
                    ...
                    this.dialogOptions.title = "Falha no processamento!"
                    this.dialogOptions.message = "Não foi possível editar o tipo de nave!"
                    this.dialogOptions.type = "error"
                    this.dialogOptions.botaoText = "Tente Novamente"
                    this.dialogOptions.dialog = true
                    this.error = true
            ...
            if (!isFormCorrect) {
                ...
                if (this.method == 'create' || this.method == null) {
                     this.salvarAlteraçõesLoading = true
                    this.defaultService.post(this.spaceShipType).then(res => {
                        this.v$.$reset();
                        this.clearInputs()
                        ...
                        this.dialogOptions.title = "Falha no processamento!"
                        this.dialogOptions.message = "Não foi possível cadastrar o tipo de nave!"
                        this.dialogOptions.type = "error"
                        this.dialogOptions.botaoText = "Tente Novamente"
                        this.dialogOptions.dialog = true
                        this.error = true
